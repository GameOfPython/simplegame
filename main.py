...
class Player(GameObject):
	def __init__(self, window ,sprite, texture, x, y):
		...
		self.walk_right.texture = self.texture
		self.walk_right.add_frame(Rectangle((0,32), (32, 32)))
		self.walk_right.add_frame(Rectangle((32,32), (32, 32)))
		self.walk_right.add_frame(Rectangle((64,32), (32, 32)))

		self.stopped = Animation()
		self.stopped.texture = self.texture
		self.stopped.add_frame(Rectangle((0,32), (32, 32)))
